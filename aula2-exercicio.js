...
// [X] Uma interface simples com campos de entrada para altura (em m) e peso (em kg)
// [X] Botão "calcular IMC" para iniciar o cálculo.

// [X]Cálculo do IMC: O IMC é calculado dividindo o peso (em kg) pela altura ao quadrado (em metros).Além
// A fórmula é: IMC = peso / (altura * altura)

// [X]Após o cálculo, o resultado do IMC deve ser exibido na interface do Usuário

// [X] Além do resultado numérico, deve ser exibida uma mensagem indicando a faixa de IMC correspondente 
...
submitFormBtn.addEventListener("click", () => {
    debugger
    let weight = getWeightInput.value
let height = getHeightInput.value
